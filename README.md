...
Die Guestbook-Applikation wird von Fleet automatisch auf den beiden Clustern azure-001 (env=dev) und rancher-001 (env=prod) eingespielt. Dabei werden die Ressourcen automatisch angepasst:
...
Wenn man in diesem Repo im Branch main eine Änderung vornimmt, wird diese automatisch auf azure-001 und/oder rancher-001 eingespielt.
